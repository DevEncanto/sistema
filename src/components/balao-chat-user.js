...
export const BalaoMessageAdmin = (props) => {
    const { message, type = "admin", typeChat, horario } = props
    ...
    const style = {
        ...
        borderRadius: `${type == "user" ? "0 7px 7px" : "7px 0 7px 7px"}`,
        background: `${type == "user" ? "#fff" : "#D9FDD3"}`,
        marginTop: "10px",
        maxWidth: "400px",
